...
export const metadata: Metadata = {
  title: 'Certificat médical - 2ème formule',
  description: 'Certificat médical 2ème formule pour la pratique du Wa-Jutsu.',
  robots: { index: false },
}

export default function Certificat2emeFormulePage() {
  return (
      ...
      <div className="max-w-3xl mx-auto px-8 py-12 print:px-4 print:py-2">
        ...
        <div className="text-center mb-10 border-b-2 border-black pb-6">
          ...
          <h2 className="text-xl font-bold uppercase text-gray-700">
            2ème formule — Aptitude avec bilan médico-sportif
          </h2>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4">
            <p className="text-sm">Certifie avoir examiné :</p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-2 text-sm">
            ...
            <label className="flex items-center gap-3">
              <span className="w-4 h-4 border border-gray-400 inline-block flex-shrink-0" />
              Examen cardio-vasculaire (auscultation, tension artérielle)
            </label>
            <label className="flex items-center gap-3">
              <span className="w-4 h-4 border border-gray-400 inline-block flex-shrink-0" />
        ...
        <section className="mb-8 border border-gray-400 p-6">
          <p className="text-sm mb-4">
            Au vu des résultats du bilan médico-sportif effectué ce jour, le patient susmentionné :
          </p>
          <div className="space-y-3 ml-4">
            <label className="flex items-center gap-3">
              <span className="w-4 h-4 border border-gray-400 inline-block flex-shrink-0" />
              <span><strong>Ne présente pas de contre-indication</strong> à la pratique du Ju-Jutsu Traditionnel (méthode Wa-Jutsu)</span>
            </label>
            <label className="flex items-center gap-3">
              <span className="w-4 h-4 border border-gray-400 inline-block flex-shrink-0" />
              <span><strong>Présente une contre-indication temporaire</strong> (préciser) :</span>
            </label>
            <div className="ml-7 border-b border-gray-400 h-8" />
            <label className="flex items-center gap-3">
              <span className="w-4 h-4 border border-gray-400 inline-block flex-shrink-0" />
              <span><strong>Présente une contre-indication définitive</strong></span>
            </label>
          </div>
          <div className="mt-4 space-y-3">
            <p className="text-sm font-semibold">Type de pratique autorisée :</p>
        ...
        <section className="mb-8">
          ...
          <div className="border border-gray-400 h-24" />
        </section>
